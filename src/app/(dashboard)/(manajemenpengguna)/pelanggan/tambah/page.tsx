...
export default function TambahPelangganPage() {
  ...
  const removeFoto = () => {
    ...
    // Reset nilai input file agar bisa pilih file yang sama lagi jika diperlukan
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      //  Simpan hasil responnya ke variabel 'result' untuk mengambil ID
      const result = await pelangganService.create(formData);
      
      //  Titipkan pesan notifikasi ke sessionStorage sebelum pindah halaman
      sessionStorage.setItem('pelanggan_notif', `Berhasil menambah pelanggan ${formData.nama_lengkap} (ID: ${result.data.id_pelanggan})!`);
  ...
  return (
    <div className="w-full max-w-4xl mx-auto relative pb-10">
      ...
      {/*  Overlay SplashScreen saat loading submit */}
      ...
      <div className="bg-white rounded-3xl border border-slate-200 shadow-xl overflow-hidden">
        ...
        <div className="bg-[#1e3a5f] p-5 text-white flex items-center gap-4">
          ...
          <div className="flex flex-col">
            <h3 className="text-base font-bold leading-tight">Formulir Data Pelanggan</h3>
            <p className="text-[11px] text-slate-300 font-medium leading-tight mt-0.5">
               Silakan masukkan data profil dan akun pelanggan baru secara lengkap.
            </p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
            ...
            {/* Input Password */}
            <div className="space-y-2">
              <label className="text-sm font-bold text-[#1e3a5f] ml-1">Password Akun</label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
            ...
            {/*  BAGIAN UPLOAD FOTO (Berbentuk input file & preview) */}
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                {/* Custom styling untuk input type file */}
                <input
                  id="foto_upload"
                  type="file"
                  accept="image/*"
              ...
              {/* Preview Gambar di bawah input jika ada */}
              {preview && (
